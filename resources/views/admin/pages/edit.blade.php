...
@section('content')
    @if ($errors->any())
        <div class="alert alert-danger">
            <ul>
                <h5><i class="icon fas fa-ban"></i>Ocorrreu Um Erro</h5>
    ...
    <script>
        tinymce.init({
            ...
            toolbar: 'undo redo | formatselect | bold italic backcolor | alignleft aligncenter alignright alignjustify | tabe | link image | bullist numlist',
            content_css: [
